      ...
      <div className="center ba b--dotted br3 bg-near-white black pa2 measure-wide">
        ...
        <ol start="65">
          <li>
            ...
            <p>
              a)The Punt Owners’ Association Committee (POA) shall be deemed to
              be a sub committee of the Club and its purpose shall be to
            ...
            <p>
              b)The Punt Owners’ Association (POA) shall have its own Rules and
              Procedures (POA Rules) so far as these do not conflict with the
              Rules or constitution of the Club. A copy of any such NPOA Rules
              must be provided to the Honorary Secretary of the Club who shall
              be notified forthwith of any change in the NPOA Rules. (included
              as Annex A below)
            </p>
          </li>
          <li>
          ...
          <li>
            ...
            <p>
              ...
              Punt Owner on the Owners’ register, and shall convene a POA Annual
              General Meeting and any Special General POA Meetings in the same
              manner as provided by Section 6 of the Club Constitution relating
              to the Annual General Meeting or any Special General Meetings of
              the Club, (so far as relevant) except that a requisition need be
              made and signed by five Punt Owners only. All Punts Owners whether
              or not Club Members shall be entitled to attend the POA Annual
              General Meeting and any Special General POA Meetings. The
              election, retirement and continuation of membership of the POA
              Committee shall be in accordance with provisions of Section 4 of
              the Club Constitution (so far as relevant) and the voting and
              procedures to be followed at such meetings shall be in accordance
              with the Club provisions therein save that at POA meetings ten
              owners shall form a quorum.
            </p>
          </li>
          <li>
            ...
            <p>
              b)The Punt Owners’ Association Secretary shall report to the Club
              Committee on any matters resolved by the POA and any subcommittees
              thereto.
            </p>
            <p>
